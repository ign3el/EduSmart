...
def generate_tts(text: str, voice: str = "af_sarah", speed: float = 1.0) -> bytes:
    ...
    """
    # Get URL from environment variable, default to the external container name
    # This matches the KOKORO_URL in your docker-compose.yml
    base_url = os.getenv("KOKORO_URL", "http://kokoro-tts:8880")
